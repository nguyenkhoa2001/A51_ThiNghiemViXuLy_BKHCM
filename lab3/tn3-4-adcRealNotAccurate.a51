...
;                   100
;   (Phan du) * ------------- ~= (Phan du) * 2      ( use 100 because need for 2 chu so thap phan nen * 10^2)
;                   51
;
;   will get error with data from ADC at these value : A = [254,203,152,101,50]
;
    PUSH B
    ...
    MOV B, #2 ; NHÂN phan du cho 2 de ra phan thap phan
    MUL AB
    MOV B, #10; chia 10 de convert thanh 2 so rieng le
    DIV AB
    MOV R7, B ; R7 la 10^-2 
    MOV R6, A ; R6 la 10^-1
    POP B
